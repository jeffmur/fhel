...
TEST(Basics, BFV)
{
    ...
    */
    ...
    EXPECT_EQ(3, x_sq_plus_one.size());
    cout << "    + noise budget in x_sq_plus_one: " << fhe->invariant_noise_budget(x_sq_plus_one) << " bits"
         << endl;
    // Note: Decryption can be incorrect if noise budget is zero.
    EXPECT_GT(fhe->invariant_noise_budget(x_sq_plus_one), 0);
    ...
    */
    ...
    EXPECT_EQ(2, x_squared.size());
    fhe->add(x_squared, plain_one, x_sq_plus_one);
    cout << "    + noise budget in x_sq_plus_one: " << fhe->invariant_noise_budget(x_sq_plus_one) << " bits"
         << endl;
    cout << "    + decryption of x_sq_plus_one: ";
    fhe->decrypt(x_sq_plus_one, decrypted_result);
    ...
    EXPECT_EQ(2, x_plus_one_sq.size());
    cout << "    + noise budget in x_plus_one_sq: " << fhe->invariant_noise_budget(x_plus_one_sq) << " bits"
         << endl;
    cout << "    + decryption of x_plus_one_sq: ";
    fhe->decrypt(x_plus_one_sq, decrypted_result);
