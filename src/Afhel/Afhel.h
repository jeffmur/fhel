/**
 * @file Afhel.h
 * Abstract Fully Homomorphic Encryption Library
 *  --------------------------------------------------------------------
 * @brief This is the main header file for Afhel, a library that provides 
 * an abstraction layer for high-level functions and configurations, 
 * facilitating compatibility with various Homomorphic Encryption libraries.
 *
 *  --------------------------------------------------------------------
